      ...
      <div className="card-controls">
        <div className="control-group">
          ...
          <button
            ...
            className={subject.attendedClasses === 0 ? 'disabled-btn' : ''}
          >
            -
          </button>
          <button onClick={() => handleUpdate('attended', 'inc')}>+</button>
        </div>
        ...
        <div className="control-group">
          ...
          <button
            ...
            className={subject.missedClasses === 0 ? 'disabled-btn' : ''}
          >
            -
          </button>
          <button onClick={() => handleUpdate('missed', 'inc')}>+</button>
        </div>
      </div>
    </div>
